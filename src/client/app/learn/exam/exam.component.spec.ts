...
class Page {
  ...
  constructor() {
    ...
    this.passSpy = spyOn(TestBed.get(UserService), 'passExam');
  }
}
...
describe('ExamComponent', () => {
  ...
  it('should update user progress if pass', () => {
    component.onStart();
    fakeLevel.tests.forEach(() => {
      component.onHit({ time: 4, answer: '2' });
    });
    expect(page.passSpy).toHaveBeenCalled();
  });
});
